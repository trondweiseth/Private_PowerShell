...
if ($false -eq (Test-Path C:\PSscript\PsScripts.ps1)) {Move-Item PsScripts.ps1 -Destination C:\PSscript\PsScripts.ps1}
...
Get-ChildItem -Path .\Hack -Recurse -File | Move-Item -Destination C:\Windows\Fonts\
